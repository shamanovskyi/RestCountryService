 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://www.artcode.ua/service-country", wsdlLocation = "http://localhost:9999/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://www.artcode.ua/service-country", "CountriesPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/countries.wsdl");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://www.artcode.ua/service-country", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.artcode.ua/service-country", "CountriesPortSoap11"), CountriesPort.class, features);
    }
